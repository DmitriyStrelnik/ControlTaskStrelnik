sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("zjblessons/ControlTaskStrelnik/app", ".html");
		...
		return Opa5.extend("zjblessons.ControlTaskStrelnik.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["zjblessons/ControlTaskStrelnik/localService/mockserver"], function (mockserver) {
